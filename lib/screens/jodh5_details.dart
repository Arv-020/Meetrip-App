...
class Jodh5DetialScreen extends StatelessWidget {
  const Jodh5DetialScreen({super.key});

  final String placeName = "Mandore Garden";
  ...
  Widget build(BuildContext context) {
    List<String> images = [
      "assets/images/jodh5.JPG",
      "assets/images/jodh5-2.jpg",
      "assets/images/jodh5-3.jpg"
    ];
    return Scaffold(
