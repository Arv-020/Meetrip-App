...
class Jodh4DetialScreen extends StatelessWidget {
  const Jodh4DetialScreen({super.key});

  final String placeName = "Jaswant Thada";
  ...
  Widget build(BuildContext context) {
    List<String> images = [
      "assets/images/jodh4.jpeg",
      "assets/images/jodh4-2.jpg",
      "assets/images/jodh4-3.jpg",
      "assets/images/jodh4-4.jpg",
    ];
    return Scaffold(
