...
class Jai2DetailScreen extends StatelessWidget {
  const Jai2DetailScreen({super.key});

  final String placeName = "Jantar Mantar";
  ...
  Widget build(BuildContext context) {
    List<String> images = [
      "assets/images/jai2.jpg",
      "assets/images/jai2-2.jpg",
      "assets/images/jai2-3.jpg"
    ];
    return Scaffold(
