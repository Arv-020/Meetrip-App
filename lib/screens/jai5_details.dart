...
class Jai5DetailScreen extends StatelessWidget {
  const Jai5DetailScreen({super.key});

  final String placeName = "Birla Mandir Temple";

  final String content =
      "Birla Mandir, Jaipur (Lakshmi Narayan Temple) is a Hindu temple located in Jaipur, India[1] and is one of many Birla mandirs.[2] It was built by the B.M. Birla Foundation in 1988 and is constructed solely of white marble.[3] It is dedicated to the Hindu Goddess Lakshmi and Lord Vishnu (Narayan),[4] whose images appear inside, along with other Hindu gods and goddesses and selections from the Gita and Upanishads.[3] Festivals such as Diwali and Janamashtami are celebrated at the temple. The temple is open daily with visiting hours between 8:00 AM and 12:00 PM, as well as between 4:00 PM and 8:00 PM.[3] It is located in Jaipur's Tilak Nagar neighborhood near Moti Dungari hill.";

  @override
  Widget build(BuildContext context) {
    List<String> images = [
      "assets/images/jai5.jpg",
      "assets/images/jai5-4.png",
      "assets/images/jai5-2.jpg",
      "assets/images/jai5-3.jpg",
    ];
    return Scaffold(
