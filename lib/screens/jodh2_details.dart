...
class Jodh2DetialScreen extends StatelessWidget {
  const Jodh2DetialScreen({super.key});

  final String placeName = "Umaid Bhawan Palace";
  ...
  Widget build(BuildContext context) {
    List<String> images = [
      "assets/images/jodh2.jpg",
      "assets/images/jodh2-2.jpg",
      "assets/images/jodh2-3.jpeg"
    ];
    return Scaffold(
