...
class Jodh3DetailScreen extends StatelessWidget {
  const Jodh3DetailScreen({super.key});

  final String placeName = "Lake Kaylana";
  ...
  Widget build(BuildContext context) {
    List<String> images = [
      "assets/images/jodh3.jpg",
      "assets/images/jodh3-2.jpg",
      "assets/images/jodh3-3.jpg"
    ];
    return Scaffold(
