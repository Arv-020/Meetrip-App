...
class Jodh1DetailScreen extends StatelessWidget {
  const Jodh1DetailScreen({super.key});

  final String placeName = "Mehrangarh Fort";
  ...
  Widget build(BuildContext context) {
    List<String> images = [
      "assets/images/jodh1.jpg",
      "assets/images/jodh1-2.jpg",
      "assets/images/jodh1-3.jpeg"
    ];
    return Scaffold(
