...
class Udai1DetailScreen extends StatelessWidget {
  const Udai1DetailScreen({super.key});

  final String placeName = "Lake Pichola";
  ...
  Widget build(BuildContext context) {
    List<String> images = [
      "assets/images/udai1.jpg",
      "assets/images/udai1-2.jpg",
      "assets/images/udai1-3.jpg"
    ];
    return Scaffold(
