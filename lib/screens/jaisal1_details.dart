...
class Jaisal1DetailScreen extends StatelessWidget {
  const Jaisal1DetailScreen({super.key});

  final String placeName = "Jaisalmer Fort";
  ...
  Widget build(BuildContext context) {
    List<String> images = [
      "assets/images/jaisal1.jpg",
      "assets/images/jaisal1-2.jpg",
      "assets/images/jaisal1-3.jpg"
    ];
    return Scaffold(
