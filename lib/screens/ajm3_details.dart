...
class Ajm3DetailScreen extends StatelessWidget {
  const Ajm3DetailScreen({super.key});

  final String placeName = "Ana Sagar Lake";
  ...
  Widget build(BuildContext context) {
    List<String> images = [
      "assets/images/ajm3.jpg",
      "assets/images/ajm3-2.jpg",
      "assets/images/ajm3-3.jpeg"
    ];
    return Scaffold(
