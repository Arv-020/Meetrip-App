...
class Udai4DetailScreen extends StatelessWidget {
  const Udai4DetailScreen({super.key});

  final String placeName = "Jagdish Temple";
  ...
  Widget build(BuildContext context) {
    List<String> images = [
      "assets/images/udai4.jpg",
      "assets/images/udai4-2.jpeg",
      "assets/images/udai4-3.jpeg"
    ];
    return Scaffold(
