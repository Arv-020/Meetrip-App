...
class Jai4DetailScreen extends StatelessWidget {
  const Jai4DetailScreen({super.key});

  final String placeName = "Sheesh Mahal";

  final String content =
      "Sheesh Mahal is a palace located in Jaipur, Rajasthan, India. It was built in 1778 during the reign of Sawai Pratap Singh and is known for its extensive use of mirrors and glasswork. The palace was used as a residence for the royal family and is now a popular tourist attraction.The walls and ceilings of the palace are adorned with tiny mirrors, creating a glittering and shimmering effect. The central hall of the palace is the main attraction and is covered with mirrors and glasswork. The architecture of the Sheesh Mahal is a blend of Hindu and Muslim styles, with a central dome surrounded by smaller domes and minarets.Sheesh Mahal is a part of the City Palace Complex in Jaipur and is a must-visit destination for anyone interested in the history and architecture of India. Visitors can admire the intricate carvings and paintings on the walls and ceilings, explore the palace, and learn about its history. The palace is also a popular tourist attraction and is visited by thousands of visitors each year.";

  @override
  Widget build(BuildContext context) {
    List<String> images = [
      "assets/images/jai4.jpg",
      "assets/images/jai4-2.jpg",
      "assets/images/jai4-3.jpg"
    ];
    return Scaffold(
